// miniprogram/pages/bleObu/ble_auth_.js
import {
...
Page({
  ...
  ble_obu_push_recv: function (res) {
    ...
    this.msg.push(ab2hex(respective))
  ...
  writeBLECharacteristicValue: function(ab) {
    ...
    let themsg = ab2hex(ab)    
    console.log('write-ble:' + themsg)
    // console.log('write ble finished')

    // let _msg = this.data.msg.push(themsg)
    // this.setData({
    //   msg: _msg
    // })
  },
